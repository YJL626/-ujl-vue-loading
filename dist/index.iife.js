var loading = (function (exports, Vue, vue) {
  'use strict';
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      vue.createVNode("img", { src: _ctx.imgSrc }, null, 8 /* PROPS */, ["src"])
    ], 4 /* STYLE */))
  }
  ...
  const loading = (app) => {
      ...
      Vue.createApp({ render: () => Vue.h(script, LoadingProps.value) }).mount(loaderC);
